...
add({ n = '', d = {"You notice him stare directly at you when he mentioned failing the class..."} })

add({ 
	n = 'CECILIA', 
	d = { "(Did he... just smirk at me? Is he making fun of me!?)" },
	c = {
		{ t = "Challenge him >:I", f = function() gs.will = gs.will - 30 end, node = 'nodes/week1/day2/will_a.lua' },
		{ t = "Be Cocky >.>", f = function() gs.will = gs.will - 50 end, node = 'nodes/week1/day2/will_b.lua' },
	}
})
...
finish = function()
	...
	add({ 
		...
		f    = next_afternoon,
		node = 'nodes/week1/day2/night2.lua' 
	})
end
