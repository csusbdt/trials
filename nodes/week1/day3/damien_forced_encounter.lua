...
add({ lg = lg.damien, d = {"(He sat in the same seat he sat in on Monday, the one right", "next to the one I sat in...)"} })
...
add({  
	...
	c = {
		{ t = "Apologize D:", f = function() gs.damien = gs.damien + 20 end, node = 'nodes/week1/day3/damien_forced_encounter_a.lua' },
		{ t = "Ignore him >.>", f = function() gs.damien = gs.damien + 10 end, node = 'nodes/week1/day3/damien_forced_encounter_b.lua' }
	}
})
