...
add({ n = 'RUBY?', d = {"Huh? O-oh... Yea... Do you need something?"} })

add({ n = 'CECILIA', d = {"Um, I just wanted to talk about Art. I-I draw a", "little myself..."} })

add({ n = 'RUBY?', d = {"O-oh? Well, the Art club is always looking for new members..."} })

add({ n = 'CECILIA', d = {"Oh? When's the next meeting? I may try and join!"} })

add({ n = 'RUBY?', d = {"W-well, there's technically a meeting right now... But as you", "can s-see, no one came."} })

add({ n = 'CECILIA', d = {"It sounds fun, but what exactly do I need to do", "for this club? Just makes art?"} })

add({ n = 'RUBY?', d = {"Yea, pretty much. There's other stuff, like participating", "in art contest and holding galleries at the end of each", "quarter... But I don't think we can if no one shows up."} })
...
add({ n = 'RUBY?', d = {"N-no, it's alright... I shouldn't be moping over something", "that can be redone."} })
...
add({ n = 'RUBY?', d = {"U-uh... I don't think that's possible... You've never", "done ceramics before... Right?"} })
...
add({ n = 'RUBY?', d = {"A-ah... Okay... Oh! By the way, my name is Ruby."} })
