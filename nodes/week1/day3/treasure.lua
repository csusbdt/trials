...
add({ 
	...
	c = {
		...
		{t = "That's it", f = function() finish() end}
	}
})
...
finish = function()
	...
	add({ n = 'CECILIA', d = {"Mmm... Just a little bit. I do know a girl who fits the marble-girl's", "description a little bit. As for the rest, I'll have to ask around."} })
	...
	add({ n = 'CECILIA', d = {"(Could that girl really be related to the ghost somehow...? At any rate, I", "should look and ask around a bit."} })
