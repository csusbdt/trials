...
choice1 = function()
	...
	add({ bg = '', d = {"The cafe wasn't as dead as you thought it was going to be.", "It seems a lot of people come here to get a late night snack."} })
	add({ n = 'CECILIA', d = {"(Hm... This looks yummy!")} })
	add({ n = '', d = {"..."} })
	add({ d = {"You had a completely peaceful time going to the cafe tonight."} })
	add({ n = 'CECILIA', bg = bg.cecilia_room_night, d = {"Time for sleep. node = 'nodes/ch1/day4/morning_encounter.lua', f = next_time })
end
