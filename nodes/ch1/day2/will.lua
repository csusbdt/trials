...
add({ 
	...
	c = {
		{ t = "Challenge him >:I", f = function() gs.will = gs.will - 30 end, node = 'nodes/ch1/day2/will_a.lua' },
		{ t = "Be Cocky >.>", f = function() gs.will = gs.will - 50 end, node = 'nodes/ch1/day2/will_b.lua' },
	}
})
...
finish = function()
	...
	add({ 
		...
		f    = next_afternoon,
		node = 'nodes/ch1/day2/night2.lua' 
	})
end
