...
add({ 
	...
	c = {
		{ t = "damien1_a", f = function() gs.damien = gs.damien + 20 end, node = 'nodes/ch1/damien1_a.lua' },
		{ t = "damien1_b", f = function() gs.damien = gs.damien + 30 end, node = 'nodes/ch1/damien1_b.lua' },
	}
})
