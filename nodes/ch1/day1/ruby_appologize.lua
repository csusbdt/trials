...
add({ d = {"As the other girl approached her, you decided to run ahead to attend class,", "hoping the teacher will go easy on you since it's a freshman class."}, node = 'nodes/ch1/day1/ruby_finish.lua' })
