...
add({ 
	...
	c = {
		{ t = "Apologize and be late. @.@", f = function() gs.ruby = gs.ruby - 40 end, node = 'nodes/ch1/day1/ruby_appologize.lua' },
		{ t = "Leave the girl. >.>", f = function() gs.lily = gs.lily - 60 end, node = 'nodes/ch1/day1/ruby_leave.lua' }
	}
})
