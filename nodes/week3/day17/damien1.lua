...
add({ n = 'DAMIEN', d = {"Hm... Well, The teacher's here. Class'll be starting soon."} })

add({ n = 'CECILIA', d = {"Huh? Oh, right... Alright."} })

add({ n = '', lg = '', bg = '', d = {"Class began a few minutes later..."} })

add({ d = {"..."}, node = 'nodes/week3/day17/afternoon.lua', f = next_time })