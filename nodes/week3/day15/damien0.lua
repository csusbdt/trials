...
add({ n = '', d = {"...He stayed silent for a while."} })

add({ d = {"Before you got a chance to ask again, the teacher started up class."} })
...
add({ 
	...
	node = 'nodes/week3/day15/afternoon.lua',
	lg = '',
	f = next_time
})